...
public class Notes4_5_Ex
{
    public static void main()
    {
        ...
        BankAccount acct1 = new BankAccount("Mrs. Denna", 500, 1234, home);
    ...
    public static void changeAddress(Address a1)
    {
        Address a2 = new Address("University of Illinois", "Urbana-Champaign", "IL", "12345-6700");
        a1 = a2;
    }
    
    public static void changeBankAcct(BankAccount temp)
    {
        temp.deposit(200);
    }
}
