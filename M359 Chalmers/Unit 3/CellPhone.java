...
/**
 * Take the VERY LONG calculateOverageCharge() method and deconstruct it into helper methods.
...
{  ;
    ...
    /*
     *  Calculates monthly phone bill depending on the data and minute plan chosen.
    ...
    {
        calculateMinuteCharge(minutesUsed);
        calculateDataCharge(gigsUsed);
        printFinalBill();
        
    }
    
    public void calculateMinuteCharge(int minutesUsed)
    {
        if (hasMinute1)
        {
    ...
    public void calculateDataCharge(double gigsUsed)
    {
        if (hasData1)
        {
    ...
    public void printFinalBill()
    {
        ...
        System.out.println("**********************************************************");
        System.out.println("********************** YOUR OVERAGES *********************");
        System.out.println("**********************************************************");
        System.out.println();
        System.out.println();
